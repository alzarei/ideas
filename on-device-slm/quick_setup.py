#!/usr/bin/env python3
"""
Quick Setup - Fast setup without downloading models
Just checks environment and launches app (download models later)
"""
...
def print_banner():
    print("""
+==============================================================+
|            QUICK SETUP WITHOUT MODELS DOWNLOADED           |
...
def main():
    print_banner()
    print("Running quick setup without downloading models...")
